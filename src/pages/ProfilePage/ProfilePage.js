            ...
            <main style={{minHeight:"100vh"}}>
                ...
                <div className="banner_image" style={{ backgroundImage: `url(${bannerProfil})` }}>
                    <div className="banner">
                        ...
                        <div className="banner_information">
                            <div>{currentUser.informations.firstname} {currentUser.informations.name}</div>
                ...
                <div style={{minHeight:"100vh" }}>
                    <div id="myBtnContainer" >
                        <ButtonFilter text="all" activeFilter={activeFilter} onFilterChange={handleFilterChange} svg={icons.all}/>
                        <ButtonFilter text="walls" activeFilter={activeFilter} onFilterChange={handleFilterChange} svg={icons.walls}/>
                        <ButtonFilter text="gallery" activeFilter={activeFilter} onFilterChange={handleFilterChange} svg={icons.gallery}/>
                        <ButtonFilter text="video" activeFilter={activeFilter} onFilterChange={handleFilterChange} svg={icons.video}/>
                        <ButtonFilter text="music" activeFilter={activeFilter} onFilterChange={handleFilterChange} svg={icons.music}/>                    
                    </div>
                    <div className="container" >
                        <div className={getFilterClass("walls")}><Wall/></div>
                        <div className={getFilterClass("gallery")}><Gallery/></div>
                        <div className={getFilterClass("video")}><Video/></div>
                        <div className={getFilterClass("music")}><Music/></div>
                    </div>
